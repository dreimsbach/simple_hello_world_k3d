...
mkdir -p "$localVolumePath/paperless/paperless-ngx"
mkdir -p "$localVolumePath/paperless/paperless-ngx-media"
mkdir -p "$localVolumePath/paperless/paperless-ngx-consume"
mkdir -p "$localVolumePath/paperless/paperless-ngx-postgres"
